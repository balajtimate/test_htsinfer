    ...
    with open(sample_table_path, "r", encoding="utf-8") as csv_file:
        ...
        for i, chunk in enumerate(chunks):
            ...
            with open(job_script_filename, 'w', encoding="utf-8") as file:
                ...
                file.write(f'#SBATCH --output=/scicore/home/zavolan/balajt0000/Work/test_htsinfer/slurm_output/{run_id}_{i}.o%j\n')
                file.write(f'#SBATCH --error=/scicore/home/zavolan/balajt0000/Work/test_htsinfer/slurm_output/{run_id}_{i}.e%j\n\n')
...
def compile_star_align_cmd(
    ...
    cmd_hts.extend(["--readFilesIn", sample])
    cmd_hts.extend(["--outFileNamePrefix", outdir])
    return cmd_hts

generate_mapping_slurm_script("test7", "mapping_tests/ref_genomes", "mismatch_mappings.csv", blocks=2)
